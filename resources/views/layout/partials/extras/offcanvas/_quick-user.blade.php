        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label"
                     style="background-image:url('{{ asset($user["profile"] ? $user["profile"] : "media/users/300_21.jpg") }}')"></div>
                    ...
                    <a href="#" class="navi-item">
                        <span class="navi-link p-0 pb-2">
                            <span class="navi-icon mr-1">
								{{ Metronic::getSVG("media/svg/icons/Communication/Adress-book1.svg", "svg-icon-lg svg-icon-primary") }}
							</span>
                            <span class="navi-text text-muted text-hover-primary text-wrap">{{$user['phone_number']}}</span>
                        </span>
                    </a>
                </div>
            </div>
