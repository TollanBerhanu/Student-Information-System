...
<div id="kt_header_mobile" class="header-mobile {{ Metronic::printClasses('header-mobile', false) }}" {{ Metronic::printAttrs('header-mobile') }}>
    ...
    <div class="mobile-toolbar">
        ...
        @if (config('layout.aside.self.display'))
            <button class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1 mobile-toggle mobile-toggle-left" id="kt_aside_mobile_toggle">
                {{ Metronic::getSVG("media/svg/icons/Layout/Layout-left-panel-2.svg", "svg-icon-xl") }}
            </button>
...
{{--        @endif--}}
        ...
        <button class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1 topbar-toggle ml-3" id="kt_header_mobile_topbar_toggle">
