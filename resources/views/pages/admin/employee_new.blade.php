...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form method="POST" enctype="multipart/form-data" action="{{ route("employeeRegisterHandle") }}">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9 col-form-label">
                        <div class="radio-inline">
                            <label class="radio">
                                <input type="radio" {{ old('sex') ? old('sex') == "Male" ? 'checked':'' : 'checked'}} value="Male" name="sex"/>
                                <span></span>
                                Male
                            </label>
                            <label class="radio">
                                <input type="radio" {{ old('sex') ? old('sex') == "Female" ? 'checked':'' : ''}} value="Female" name="sex"/>
                                <span></span>
                                Female
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" type="tel" value="{{ old('phone_number') }}" name="phone_number"/>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="example-password-input" class="col-2 col-form-label">Password</label>
                    <div class="col-10">
                        <input class="form-control" value="0987654321" name="password"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control form-control-solid" name="college_id">
                        ...
                        @foreach($colleges as $college)
                            <option value="{{$college['id']}}" {{old('college_id') ? (old('college_id') == $college['id'] ? "selected" : "") : "" }}>{{$college['name']}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
