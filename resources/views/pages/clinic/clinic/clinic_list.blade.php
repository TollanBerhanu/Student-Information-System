        ...
        <div class="card-body">
            ...
            >
                ...
                @foreach($clinics as $clinic)
                    <tr>
                        <td>{{ $clinic['name'] }}</td>
                        <td class="text-justify">{{ $clinic['description'] }}</td>
                        <td>{{ $clinic['college'] ? $clinic['college']['name'] : "Unassigned" }}</td>
                        <td>{{ $clinic['active'] ? 1 : 2 }}</td>
                        <td>{{ $clinic['id']}}</td>
                    </tr>
                @endforeach
                </tbody>
                ...
                let datatable = $("#kt_datatable").KTDatatable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            template: function template(row) {
                                return (
                                    `<a href="/clinic/clinic/update/${row['Action']}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
