            ...
            >
                ...
                @foreach($room_services as $room_service)
                    <tr>
                        ...
                        <td class="text-justify">{{ $room_service['description'] }}</td>
                        <td>{{ $room_service['room'] ? $room_service['room']['clinic']['name'] : "Unassigned" }}</td>
                        <td>{{ $room_service['room'] ? $room_service['room']['name'] : "Unassigned" }}</td>
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            template: function template(row) {
                                return (
                                    ` <a href="/clinic/room/service/update/${row['Action']}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
