...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form method="POST" enctype="multipart/form-data" action="{{ route("diseaseUpdateHandle") }}">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" type="text" value="{{ old('name') ? old('name') : $disease['name'] }}" name="name"/>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-2 col-form-label">Name</label>
                    <div class="col-10">
                        <input class="form-control" type="text" value="{{ old('code') ? old('code') : $disease['code'] }}" name="code"/>
                    </div>
                </div>
                <div class="form-group">
                    <label>Description</label>
                    <textarea class="form-control form-control-solid" rows="3" name="description">{{old('description') ? old('description') : $disease['description']}}</textarea>
                </div>
            </div>
