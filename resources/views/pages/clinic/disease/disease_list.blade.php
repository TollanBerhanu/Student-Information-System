        ...
        <div class="card-body">
            ...
            >
                ...
                @foreach($diseases as $disease)
                    <tr>
                        <td>{{ $disease['name'] }}</td>
                        <td class="text-justify">{{ $disease['description'] }}</td>
                        <td class="text-justify">{{ $disease['code'] }}</td>
                        <td>{{ $disease['id']}}</td>
                    </tr>
                @endforeach
                </tbody>
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            template: function template(row) {
                                return (
                                    `<a href="/clinic/disease/update/${row['Action']}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
